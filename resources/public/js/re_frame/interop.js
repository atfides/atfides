...
return [cljs.core.str((function (){var pred__24981 = cljs.core.instance_QMARK_;
var expr__24982 = reactive_val;
if(cljs.core.truth_(pred__24981.call(null,reagent.ratom.RAtom,expr__24982))){
return "ra";
} else {
if(cljs.core.truth_(pred__24981.call(null,reagent.ratom.RCursor,expr__24982))){
return "rc";
} else {
if(cljs.core.truth_(pred__24981.call(null,reagent.ratom.Reaction,expr__24982))){
return "rx";
} else {
if(cljs.core.truth_(pred__24981.call(null,reagent.ratom.Track,expr__24982))){
return "tr";
} else {
return "other";
}
