...
var vec__24661_24662 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_24663 = cljs.core.nth.call(null,vec__24661_24662,(0),null);
var only_after_24664 = cljs.core.nth.call(null,vec__24661_24662,(1),null);
var db_changed_QMARK__24665 = (cljs.core.some_QMARK_.call(null,only_before_24663)) || (cljs.core.some_QMARK_.call(null,only_after_24664));
if(db_changed_QMARK__24665){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_24663);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_24664);
...
var map__24672 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__24672__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__24672__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__24680 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var event = cljs.core.get.call(null,map__24680__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__17951__auto___24683 = arguments.length;
var i__17952__auto___24684 = (0);
while(true){
if((i__17952__auto___24684 < len__17951__auto___24683)){
args__17958__auto__.push((arguments[i__17952__auto___24684]));

var G__24685 = (i__17952__auto___24684 + (1));
i__17952__auto___24684 = G__24685;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__17959__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq24682){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq24682));
});
/**
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__16893__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__17958__auto__ = [];
var len__17951__auto___24691 = arguments.length;
var i__17952__auto___24692 = (0);
while(true){
if((i__17952__auto___24692 < len__17951__auto___24691)){
args__17958__auto__.push((arguments[i__17952__auto___24692]));

var G__24693 = (i__17952__auto___24692 + (1));
i__17952__auto___24692 = G__24693;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__17959__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__24686_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__24687_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__24687_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__16881__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq24688){
var G__24689 = cljs.core.first.call(null,seq24688);
var seq24688__$1 = cljs.core.next.call(null,seq24688);
var G__24690 = cljs.core.first.call(null,seq24688__$1);
var seq24688__$2 = cljs.core.next.call(null,seq24688__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__24689,G__24690,seq24688__$2);
});
