...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__17491__auto__,writer__17492__auto__,opt__17493__auto__){
return cljs.core._write.call(null,writer__17492__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__23975 = o;
(G__23975[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__16881__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__16881__auto__){
var and__16881__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__23983 = jsprops;
(G__23983["defaultValue"] = value);

(G__23983["onChange"] = ((function (G__23983,v,value,on_change){
return (function (p1__23981_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__23981_SHARP_);
});})(G__23983,v,value,on_change))
);
...
var vec__23988 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__23988,(0),null);
var id = cljs.core.nth.call(null,vec__23988,(1),null);
var class$ = cljs.core.nth.call(null,vec__23988,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___23991 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4429__auto___23991 == null)){
} else {
var key_23992 = temp__4429__auto___23991;
(jsprops["key"] = key_23992);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__23994 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__23994["name"] = c);
...
var len__17951__auto___24000 = arguments.length;
var i__17952__auto___24001 = (0);
while(true){
if((i__17952__auto___24001 < len__17951__auto___24000)){
args__17958__auto__.push((arguments[i__17952__auto___24001]));

var G__24002 = (i__17952__auto___24001 + (1));
i__17952__auto___24001 = G__24002;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__17959__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq23998){
var G__23999 = cljs.core.first.call(null,seq23998);
var seq23998__$1 = cljs.core.next.call(null,seq23998);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__23999,seq23998__$1);
});
...
break;
default:
var G__24006 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__24006;
continue;
...
var n__17796__auto___24009 = a.length;
var i_24010 = (0);
while(true){
if((i_24010 < n__17796__auto___24009)){
(a[i_24010] = reagent.impl.template.as_element.call(null,(a[i_24010])));
...
var a = cljs.core.into_array.call(null,s);
var n__17796__auto___24012 = a.length;
var i_24013 = (0);
while(true){
if((i_24013 < n__17796__auto___24012)){
var val_24014 = (a[i_24013]);
if((cljs.core.vector_QMARK_.call(null,val_24014)) && ((reagent.impl.template.key_from_vec.call(null,val_24014) == null))){
(o["no-key"] = true);
} else {
}

(a[i_24013] = reagent.impl.template.as_element.call(null,val_24014));
...
var ctx = {};
var vec__24017 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__24017,(0),null);
var derefed = cljs.core.nth.call(null,vec__24017,(1),null);
...
var G__24019 = (cljs.core.count.call(null,argv) - first_child);
switch (G__24019) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__24019){
